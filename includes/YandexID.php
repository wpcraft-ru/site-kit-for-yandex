...
class YandexID
{
    ...
    {
      //Яндекс ID — это единая учётная запись для доступа к сервисам Яндекса и партнёрским сайтам и приложениям с поддержкой этой авторизации; она позволяет безопасно входить в аккаунты, управлять личными данными, платёжными реквизитами и настройками, а также упрощает процесс авторизации — без необходимости запоминать множество логинов и паролей.
